...
const  Hero=()=> {
  return (
    <section className="position-relative overflow-hidden py-5 mb-5 px-4">
        ...
        <div className="col-md-10 d-md-flex mt-md-n4">
          ...
          <div className="d-block hover-img-scale position-relative zindex-5 mt-md-5 mx-auto me-md-n5 mb-4 mb-md-0" style={{maxWidth: "633px"}}>
            <div className="pt-md-5 mt-4 me-md-n5">
              <h2 className="h4 mb-2 pb-1 ms-md-3"><a className="nav-link stretched-link d-flex align-items-center justify-content-center justify-content-md-start" href="real-estate-home-v1.html"><i className="fi-layers text-primary me-2 pe-1"></i><span>Automated </span></a></h2>
              <div className="position-relative zindex-0"><img className="position-relative zindex-5 rounded-md" src={image2} alt="Real Estate Demo"/>
          ...
          <div className="d-block hover-img-scale position-relative mt-md-n5 mx-auto me-md-n3" style={{maxwidth: "550px"}}>
            <h2 className="h4 ms-md-3"><a className="nav-link stretched-link d-flex align-items-center justify-content-center justify-content-md-start" href="job-board-home-v1.html"><i className="fi-security text-primary me-2 pe-1"></i><span>Testing</span></a></h2><img className='rounded-md' src={image4} alt="Job Board Demo"/>
          </div>
        </div>
         ...
         {/*  <!-- Car Finder-->*/}
          ...
          <div className="d-block hover-img-scale position-relative mt-md-n5 mx-auto me-md-n3" style={{maxWidth: "636px"}}>
            <div className="d-flex flex-column">
              <h2 className="h4 order-md-2 mb-4 mb-md-0 mt-md-4"><a className="nav-link stretched-link d-flex align-items-center justify-content-center justify-content-md-start" href="car-finder-home.html"><i className="fi-code text-primary me-2 pe-1"></i><span>Analysis</span></a></h2><img className="d-block order-md-1 mt-md-n2 rounded-md" src={image3} alt="Car Finder Demo"/>
            </div>
          </div>
        </div>
      </div>
