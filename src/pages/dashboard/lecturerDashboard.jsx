...
<Link to='/lecturer/create/assignment' type="button" className="btn btn-primary mb-2 w-100">
  <i className="fi-plus me-2"></i>
  create assignment 
</Link>

<Link to='/lecturer/view/assignments' type="button" className="btn btn-dark w-100">
...
<h5 className="card-title">Assignment Completion</h5>
  ...
  <div className="progress mt-1 mb-1">
  <div className="progress-bar progress-bar-striped progress-bar-animated bg-danger" role="progressbar" style={{width:'10%'}} aria-valuenow="45" aria-valuemin="0" aria-valuemax="100"></div>
</div>
  ...
  <div className="progress mt-1 mb-1">
  <div className="progress-bar progress-bar-striped progress-bar-animated bg-accent" role="progressbar" style={{width:'75%'}} aria-valuenow="45" aria-valuemin="0" aria-valuemax="100"></div>
</div>
