...
function ProfileDetailPage() {
  ...
  const [isStudentIdOpen, setStudentIdOpen] = useState(false);
  const [isIndexNumberOpen, setIndexNumberOpen] = useState(false);
  ...
  const toggleStudentId = () => setStudentIdOpen(!isStudentIdOpen);
  const toggleIndexNumber = () => setIndexNumberOpen(!isIndexNumberOpen);
  const toggleProgram = () => setProgramOpen(!isProgramOpen);
  const toggleClass = () => setClassOpen(!isClassOpen);
                ...
                <div className="border-bottom pb-3 mb-3">
                  <div className="d-flex align-items-center justify-content-between">
                    <div className="pe-2">
                      ...
                      <div id="phone-value">4223320</div>
                    </div>
                    <div className="me-n3" onClick={toggleIndexNumber}>
                      <a className="nav-link py-0" href="#phone-collapse" data-bs-toggle="collapse"><i className="fi-edit"></i></a>
                    </div>
                  </div>
                  <Collapse isOpen={isIndexNumberOpen}>
                    <input className="form-control mt-3" type="text" data-bs-binded-element="#phone-value" data-bs-unset-value="Not specified" value="4277320" />
                  </Collapse>
                </div>
                ...
                <div className="border-bottom pb-3 mb-3">
                  <div className="d-flex align-items-center justify-content-between">
                    <div className="pe-2">
                      ...
                      <div id="company-value">Computer Science</div>
                    </div>
                    <div className="me-n3" onClick={toggleProgram}>
                      <a className="nav-link py-0" href="#company-collapse" data-bs-toggle="collapse"><i className="fi-edit"></i></a>
                    </div>
                  </div>
                  <Collapse isOpen={isProgramOpen}>
                    <input className="form-control mt-3" type="text" data-bs-binded-element="#company-value" data-bs-unset-value="Not specified" value="Computer Science" />
                  </Collapse>
                </div>
                ...
                <div className="border-bottom pb-3 mb-3">
                  <div className="d-flex align-items-center justify-content-between">
                    <div className="pe-2">
                      ...
                      <div id="bio-value">2nd Year</div>
                    </div>
                    <div className="me-n3" onClick={toggleClass}>
                      <a className="nav-link py-0" href="#bio-collapse" data-bs-toggle="collapse"><i className="fi-edit"></i></a>
                    </div>
                  </div>
                  <Collapse isOpen={isClassOpen}>
                    <input className="form-control mt-3" type="text" data-bs-binded-element="#bio-value" data-bs-unset-value="Not specified" value="2nd Year" />
                  </Collapse>
                </div>
